    ...
    return(
        ...
        ends>
            ...
            <Paragraph>
                ...
                &nbsp;Software designer with 1 <abbr>UX</abbr> designer, 4 developers, 1 product owner, and 1 project manager
            </Paragraph>
            <Paragraph>
        ...
        ends>
            ...
            <Paragraph>
                ...
                healthcare client in executing an end-to-end design project.
            </Paragraph>
            <IndentInner>
                <Strong>
        ...
        <FrostedGlass>
            <ImageFluid>
                <Image
                src='/soulfx/soulfx-end-to-end.png'
        ...
        <FrostedGlass>
            <ImageFluid>
                <Image
                src='/soulfx/soulfx-record-ia.png'
        ...
        <FrostedGlass>
            <SectionInner>
                <Heading type={4} className='heavy'>Record Management Dashboard</Heading>
                <Paragraph>
            ...
            <ImageFluid>
                <Image item
                src='/soulfx/soulfx-company_list.svg'
                alt='Company record list' />
                <Image item
                src='/soulfx/soulfx-cert_list.svg'
            ...
            <ImageFluid>
                <Image item
                src='/soulfx/soulfx-company_details.svg'
                alt='Company details' />
                <Image item
                src='/soulfx/soulfx-program_details.svg'
                alt='Program details'/>
            </ImageFluid>
            <ImageCaption>
            ...
            <ImageFluid>
                <Image item
                src='/soulfx/soulfx-company_addition.svg'
                alt='Record addition' />
                <Image item
            ...
            <SectionInner>
                <Heading type={4} className='heavy'>Public-facing Portal</Heading>
                <Paragraph>
            ...
            <ImageFluid>
                <Image item
                src='/soulfx/soulfx-program_selection.svg'
                alt='Program selection' />
                <Image item
                src='/soulfx/soulfx-program_cards.svg'
        ...
        ends>
            <SectionInner>
                <Heading type={4} className='heavy'>Breadcrumb Navigation</Heading>
                <Paragraph>
            ...
            <ImageFluid>
                <Image screen
                src='/soulfx/soulfx-breadcrumbs.svg'
                alt='Breadcrumbs'/>
            </ImageFluid>
            <SectionInner>
                <Heading type={4} className='heavy'>Activation Switches</Heading>
                <Paragraph>
