    ...
    return (
        ...
        ends>
            ...
            <Paragraph>
                ...
                &nbsp;Leading designer with 1 product designer, 5 developers, 1 technical product manager, and 1 product owner
            </Paragraph>
            <Paragraph>
        ...
        alt='Screenshot of the final Pick History interface' />
        ...
        <Section>
            ...
            <Paragraph>
                Transaction logs — collectively referred to as <abbr>TRX</abbr> — were key elements of the previous
                operations platform. They recorded every task performed by store colleagues (also known as <abbr>PCX</abbr> specialists)
                throughout the preparation process of a customer order.
            </Paragraph>
            <IndentInner>
                <Strong>
                <abbr>TRX</abbr> was a tool used by <abbr>PCX</abbr> specialists to ensure consistent and timely fulfillment of customer orders.
                </Strong>
            </IndentInner>
            <Paragraph>
            ...
            <Paragraph>
                Through the details presented by transactions, specialists were able to validate orders by:
            </Paragraph>
            <List
            numbered>
                <li>
        ...
        ends>
            <SectionInner>
                <Heading type={4} className='heavy'>Log Interface</Heading>
                <Paragraph>
        ...
        <Section>
            ...
            <Paragraph>
                My first few weeks on this project were spent learning about our problem space. I took an in-depth look at the end-to-end
                journey of an online grocery order and the role served by <abbr>TRX</abbr> within the <abbr>PCX</abbr> ecosystem. Furthermore,
                I conversed with several colleagues to learn about what a day of operating a store — or multiple stores — is like.
            </Paragraph>
            <IndentInner>
                <Strong>
        ...
        ends>
            <SectionInner>
                <Heading type={4} className='heavy'>Ambiguous Information</Heading>
                <Paragraph>
            ...
            <SectionInner>
                <Heading type={4} className='heavy'>Tedious Item Tracking</Heading>
                <Paragraph>
            ...
            <SectionInner>
                <Heading type={4} className='heavy'>Laborious Navigation</Heading>
                <Paragraph>
                    Transaction logs for larger orders can span over 15 pages in length —
                    navigation interactions were limited to two sets of “Next” and “Previous” buttons.
                </Paragraph>
            </SectionInner>
            <ImageFluid>
                <Image
        ...
        <Section>
            ...
            <Paragraph>
                After uncovering problems with <abbr>TRX</abbr>, we outlined three areas for a new design to innovate in:
            </Paragraph>
            <List
            numbered>
                <li>
                    <Paragraph>
                        <span className='bold'>Clarity
                        </span>
                        <br />Leverage natural language to make transactions easier to understand
                    </Paragraph>
                </li>
                <li>
                    <Paragraph>
                        <span className='bold'>Cohesiveness</span>
                        <br />Simplify item tracking by connecting transactions of the same journey(s)
                    </Paragraph>
                </li>
                <li>
                    <Paragraph>
                        <span className='bold'>Scalability</span>
                        <br />Enhance navigation by enabling it to adapt to varying order sizes
                    </Paragraph>
                </li>
            </List>
            <IndentInner>
                <Strong>
                    As <abbr>PCX</abbr> specialists, we need to be able to quickly find any item within a customer order
                    so that we can identify what has happened to it.
                </Strong>
            </IndentInner>
            <Paragraph>
                Because <abbr>TRX</abbr> was accessed via desktop workstations, we needed to conform to the following constraints:
            </Paragraph>
            <List>
                <li>
                    <Paragraph>
                        The new interface must be designed for display on a single monitor with a 16:9 aspect ratio
                    </Paragraph>
                </li>
                <li>
                    <Paragraph>
                ...
                <li>
                    <Paragraph>
                        There needed to be a limit on the number of transactions that can be queried and displayed simultaneously
                    </Paragraph>
                </li>
            </List>
            <IndentInner>
                <Strong>
                    Our ideations produced some radical changes to <abbr>TRX</abbr>, now known as the Pick History.
                </Strong>
            </IndentInner>
        </Section>
        <FrostedGlass
        ends>
            <SectionInner>
                <Heading type={4} className='heavy'>Reworked Interface Layout</Heading>
                <Paragraph>
            ...
            <SectionInner>
                ...
                <Paragraph>
                    To streamline item tracking, I grouped transactions based on the items they belong to. Each transaction set
                    is sorted latest-first so that the most “current” state of each item is available to users upfront.
                </Paragraph>
            </SectionInner>
            <ImageFluid>
                <Image screen
            ...
            <SectionInner>
                <Heading type={4} className='heavy'>New Search Function</Heading>
                <Paragraph>
                    Colleagues will often go into <abbr>TRX</abbr> knowing exactly which items they want to look into.
                    We introduced a search function to enable access to these items without the need for too much scrolling.
                </Paragraph>
            </SectionInner>
            <ImageFluid>
                <Image
                ...
                src='/loblaw/ph_redesign_navbar.png'
                alt='New search bar' />
            </ImageFluid>
        </FrostedGlass>
        ...
        <Section>
            ...
            <Paragraph>
                I ran moderated usability tests and had several <abbr>PCX</abbr> specialists conduct mock
                order investigations using a prototype of our redesign. My script outlined scenarios they
                would encounter during a typical day at a store.
            </Paragraph>
            <IndentInner>
                <Strong>
                    The Pick History's design excelled in cutting the overall interaction cost of item status
                    identification. However, some elements of our new interface were found to be unintuitive.
                </Strong>
            </IndentInner>
        </Section>
        <FrostedGlass
        ends>
            <SectionInner>
                <Heading type={4} className='heavy'>🦾 Strengths</Heading>
                <List>
                    <li>
                        <Paragraph>
            ...
            <SectionInner>
                <Heading type={4} className='heavy'>🩹 Weaknesses</Heading>
                <List
                ends>
                    <li>
                        <Paragraph>
                    ...
                    <li>
                        <Paragraph>
                            Latest-first transaction sequencing was unintuitive
                            and felt more like a “backwards flow”
                        </Paragraph>
                    </li>
                </List>
            </SectionInner>
        ...
        ends>
            <SectionInner>
                <Heading type={4} className='heavy'>Transaction Card Iterations</Heading>
            </SectionInner>
            <ImageFluid>
                <Image
            ...
            <SectionInner>
                <Heading type={4} className='heavy'>Navigation Column Iterations</Heading>
            </SectionInner>
            <ImageFluid>
                <Image
                end
        ...
        <Section>
            ...
            <IndentInner>
                <Strong>
                    I designed and introduced key visuals to call out transactions of concern and “isolate”
                    timelines for different item journeys.
                </Strong>
            </IndentInner>
        </Section>
        <FrostedGlass
        ends>
            <SectionInner>
                    <Heading type={4} className='heavy'>"[An icon] is Worth a Thousand Words"</Heading>
                    <Paragraph>
                        In adherence to a classic aphorism, timeline icons serve as indicators for
                        transactions that fall outside of the expected pick actions as well as preparation completion.
                    </Paragraph>
                </SectionInner>
                <ImageFluid>
                    <Image
            ...
            <SectionInner>
                <Heading type={4} className='heavy'>Traffic Light Colour Sequence</Heading>
                <Paragraph>
        ...
        <Section>
            ...
            <Paragraph>
                It was confirmed later down our project roadmap that the search function within our new
                module would be contextualized to each individual order.
            </Paragraph>
            <IndentInner>
                <Strong>
        ...
        <Section>
            ...
            <IndentInner>
                <Strong>
                    The Pick History module was shipped and deployed to stores as part of the Ops Portal rollout.
                </Strong>
            </IndentInner>
        </Section>
        <FrostedGlass
        ends>
            <SectionInner>
                <Heading type={4} className='heavy'>Pattern Library</Heading>
                <Paragraph>
                    Components have been styled in accordance with the <abbr>PCX</abbr> design system.
                </Paragraph>
            </SectionInner>
            <ImageFluid>
                <Image
                src='/loblaw/ph_pattern_library.png'
                alt='Pattern library components' />
            </ImageFluid>
            <SectionInner>
                <Heading type={4} className='heavy'>Launch-Ready Design</Heading>
                <Paragraph>
        ...
        ends>
            ...
            <Paragraph>
                The “form follows function” principle is easily extended into any form of design. Leading the rebuild
                of <abbr>TRX</abbr> reinforced my understanding of what it means to design with purpose. Every creation or
                change throughout the project - from palette changes to reformed interactions - was driven by an intended
                function or goal, ensuring that every decision made was informed.
            </Paragraph>
            <IndentInner>
                <Heading type={4}>The tug-of-war between stakeholder requirements and technical constraints is endless</Heading>
            </IndentInner>
            <Paragraph>
            ...
            <Paragraph>
                Taking ownership of the Pick History design process instilled me with confidence in my ability to navigate ambiguity
                and taught me about the importance of seeking context to solving a problem. <abbr>TRX</abbr> presented a simple-looking
                interface that belied a complex layer of information — an understanding of <abbr>PCX</abbr> as a business was fundamental
                to identifying challenges and opportunities associated with its role in fulfillment operations.
            </Paragraph>
        </Section>
        <Section
        ends>
